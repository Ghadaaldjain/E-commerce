...
while ($row = fetch_array($query)) {
    ...
    // calling the display_image once we have the image name
    ...
    <div class="form-group">
      <label for="product-title">Product Category</label>
         <select name="product_category_id" id="" class="form-control">
            ...
            <option value=""> <?php show_product_category_title($product_category_id); ?></option>
         </select>
    </div>
...
<!-- Product Tags -->
    ...
    <div class="form-group">
        ...
        <img width= '100px' src="../../resources/<?php echo $product_image  ?>" alt=" "> <br> <br>
